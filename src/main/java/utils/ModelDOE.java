...
public class ModelDOE {
	...
	public ModelDOE(Commit currentCommit) {
		super();
	...
	public int getAdds(Contributor contributor, File file) {
		...
		commitsFile.addAll(commitFileDao.findByAuthorsFileToVersion(contributors, file, currentCommit));
	...
	public int getNumDays(Contributor contributor, File file) {
		...
		dates.add(commitFileDao.findLastByAuthorsFileToVersion(contributors, file, currentCommit));
